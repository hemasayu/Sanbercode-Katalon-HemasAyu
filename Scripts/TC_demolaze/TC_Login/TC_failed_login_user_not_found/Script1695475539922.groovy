...
WebUI.setText(findTestObject('demoblaze/login/input_username'), 'randomism')

WebUI.setText(findTestObject('demoblaze/login/input_password'), 'randompassword')

WebUI.click(findTestObject('demoblaze/login/login_btn'))

if (WebUI.verifyAlertPresent(0) == true) {
    alertUserNotExist = WebUI.getAlertText()

    WebUI.verifyMatch(alertUserNotExist, userNotExist, false)
