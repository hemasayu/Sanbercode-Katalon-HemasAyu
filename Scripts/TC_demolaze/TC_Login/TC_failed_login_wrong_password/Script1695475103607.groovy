...
WebUI.setText(findTestObject('demoblaze/login/input_password'), 'WrongPassword')

WebUI.click(findTestObject('demoblaze/login/login_btn'))

if (WebUI.verifyAlertPresent(0) == true) {
    alertFailedLogin = WebUI.getAlertText()

    WebUI.verifyMatch(alertFailedLogin, alertWrongPassword, false)
