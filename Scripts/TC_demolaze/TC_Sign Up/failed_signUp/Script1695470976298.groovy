...
WebUI.setText(findTestObject('demoblaze/SignUp/input_username'), registeredUser)

WebUI.setText(findTestObject('demoblaze/SignUp/input_password'), password)

WebUI.click(findTestObject('demoblaze/SignUp/signup_btn'))

if (WebUI.verifyAlertPresent(0) == true) {
    alertFailed = WebUI.getAlertText()

    WebUI.verifyMatch(alertFailed, registerFailed, false)
